  ...
  return (
    <div className="relative z-10 w-full min-h-screen flex flex-col justify-center items-center px-4 md:px-8 py-20 opacity-0" ref={containerRef}>
      ...
      <div className="w-full max-w-4xl mx-auto text-center flex flex-col items-center mb-10 md:mb-16 relative z-20 flex-none mt-10 md:mt-0">
        <span className="font-mono text-[11px] tracking-widest font-semibold text-emerald-400 bg-emerald-950/40 border border-emerald-800/50 rounded-full px-3 py-1 uppercase mb-4">
      ...
      {/* Grid: Projetos */}
      {activeTab === 'projetos' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl mx-auto transition-all duration-500 relative z-20 flex-none">
          {/* Card 1 */}
          <div 
            className="bg-[#121814]/60 border border-white/[0.08] hover:border-emerald-500/30 rounded-2xl p-7 md:p-8 backdrop-blur-md transition-all duration-300 flex flex-col group"
            style={{ padding: '32px', minHeight: '460px', position: 'relative' }}
          >
            <div className="w-full relative z-10 flex-grow">
              <span className="inline-block text-[11px] font-mono tracking-widest text-emerald-400 bg-emerald-950/40 border border-emerald-800/50 px-3 py-1 rounded-full mb-6 uppercase">
                ENTREGA EM ATÉ 48H
              </span>
              <h3 className="text-xl font-bold text-white mb-2">Landing Express</h3>
              ...
              <ul className="space-y-4 text-xs text-stone-400 mb-8">
                {['No ar em até 48 horas', 'Foco total em conversão no WhatsApp', 'Carregamento instantâneo no mobile', 'Domínio e hospedagem configurados'].map((item, i) => (
                  <li key={i} className="flex items-start">
                    <Check className="w-4 h-4 text-emerald-400 shrink-0 mr-2 mt-0.5" /> {item}
                  </li>
                ))}
              </ul>
            </div>
            <a href="https://wa.me/5551999019398" target="_blank" rel="noopener noreferrer" className="w-full py-3 rounded-xl text-xs font-semibold text-white bg-white/5 border border-white/10 text-center hover:bg-white/10 transition-all mt-auto pt-4 block relative z-10">
          ...
          {/* Card 2 */}
          <div 
            className="bg-[#121814]/60 border border-emerald-500/40 shadow-[0_0_30px_rgba(34,197,94,0.15)] rounded-2xl p-7 md:p-8 backdrop-blur-md transition-all duration-300 flex flex-col transform md:-translate-y-4 relative overflow-hidden group"
            style={{ padding: '32px', minHeight: '460px', position: 'relative' }}
          >
            ...
            <div className="w-full relative z-10 flex-grow">
              <span className="inline-block text-[11px] font-mono tracking-widest text-emerald-300 bg-emerald-950/80 border border-emerald-500/50 px-3 py-1 rounded-full mb-6 uppercase font-bold">
                ★ MAIS ESCOLHIDO
              </span>
              <h3 className="text-xl font-bold text-white mb-2">Institucional & B2B</h3>
            ...
            <a href="https://wa.me/5551999019398" target="_blank" rel="noopener noreferrer" className="w-full py-3 rounded-xl text-xs font-semibold text-emerald-950 bg-emerald-400 hover:bg-emerald-300 text-center transition-all shadow-[0_0_20px_rgba(16,185,129,0.4)] mt-auto pt-4 block relative z-10">
              Solicitar Orçamento →
            </a>
          </div>
          ...
          >
            <div className="w-full relative z-10 flex-grow">
              <span className="inline-block text-[11px] font-mono tracking-widest text-stone-400 bg-white/5 border border-white/10 px-3 py-1 rounded-full mb-6 uppercase">
                EXCLUSIVO
              </span>
              <h3 className="text-xl font-bold text-white mb-2">Software & Web 3D</h3>
      ...
      {activeTab === 'manutencao' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl mx-auto transition-all duration-500 relative z-20 flex-none">
          {/* Manutenção 1 */}
          <div 
            className="bg-[#121814]/60 border border-white/[0.08] hover:border-emerald-500/30 rounded-2xl p-7 md:p-8 backdrop-blur-md transition-all duration-300 flex flex-col group"
            style={{ padding: '32px', minHeight: '460px', position: 'relative' }}
          >
            <div className="w-full relative z-10 flex-grow">
              <h3 className="text-xl font-bold text-white mb-2">Suporte Standard</h3>
              <p className="text-emerald-400 font-semibold mb-4 text-sm">Hospedagem & Blindagem</p>
              <ul className="space-y-4 text-xs text-stone-400 mb-8 mt-6">
          ...
          {/* Manutenção 2 */}
          <div 
            className="bg-[#121814]/60 border border-emerald-500/40 shadow-[0_0_30px_rgba(34,197,94,0.15)] rounded-2xl p-7 md:p-8 backdrop-blur-md transition-all duration-300 flex flex-col group relative overflow-hidden"
            style={{ padding: '32px', minHeight: '460px', position: 'relative' }}
          >
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-400 to-transparent opacity-50 z-0" />
            <div className="w-full relative z-10 flex-grow">
              <h3 className="text-xl font-bold text-white mb-2">Gestão Growth</h3>
